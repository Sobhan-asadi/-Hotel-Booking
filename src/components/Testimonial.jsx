...
const Testimonial = () => {
  const cardsData = [
    {
      ...
      name: "Emily Carter",
      handle: "Stayed in Deluxe Sea View Room",
      date: "August 15, 2025",
    },
    {
      image:
    ...
    },
    {
      ...
      name: "Ethan Johnson",
      handle: "Visited Quickstay Dubai",
      date: "July 9, 2025",
    },
    {
      image:
  ...
  const CreateCard = ({ card }) => (
    <div className="mx-4 w-72 shrink-0 rounded-lg p-4 shadow transition-all duration-200 hover:shadow-lg">
      ...
      <p className="py-4 text-sm text-gray-800">
        “Our stay at Ogo Hoyel was unforgettable! The staff were friendly and
  ...
  return (
    <>
      <div className="">
        <div className="flex flex-col px-6 pt-5 pb-16 md:px-16 lg:px-24">
          <Title
            title="What Our Guests Say"
            subTitle="Discover why discerning travelers consistently choose Ogo Hoyel for their exclusive and luxurious accommodations around the world."
            align="left"
          />
        </div>
        <style>{`
        ...
        <div className="marquee-row relative mx-auto w-full max-w-6xl overflow-hidden">
